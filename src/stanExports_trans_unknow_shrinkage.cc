...
#include "stanExports_trans_unknow_shrinkage.h"

RCPP_MODULE(stan_fit4trans_unknow_shrinkage_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_trans_unknow_shrinkage")
